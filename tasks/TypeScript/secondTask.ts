...
const site = new InternetResource('fimlov.net', [{
    topic: 'films',
    payloads: [{text: 'best film', url: 'best_films.net'}]
}])
const book = new Book('just a book', [{topic: 'films', payloads: [{page: 1, line: 10, text: 'bla-bla'},{page: 2, line: 40, text: 'blo-blo'}]}]);
const book2 = new Book('book on sky', [{topic: 'sky', payloads: [{page: 1, line: 10, text: 'cool sky'}]}]);
